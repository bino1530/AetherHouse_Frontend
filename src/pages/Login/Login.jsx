...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!email) return setMsg({ error: "Please enter email", success: "" });
    if (password.length < MIN_PASS)
      return setMsg({
        error: `Password must be ≥ ${MIN_PASS} characters`,
        success: "",
      });
    ...
    try {
      ...
      setMsg({ error: "", success: "Login successfully!" });
  ...
  // map thông điệp BE → UI
  let uiText = errorText;
  if (/account not approved/i.test(errorText)) {
    uiText = "Mày bị bann";              
  }
  setMsg({ error: uiText, success: "" });
   setLoading(false);
    } 
  };
      ...
      <div className="signup-box">
        ...
        <form onSubmit={handleSubmit} className="form">
          ...
          <input
            type="password"
            name="password"
            placeholder={`Password (≥ ${MIN_PASS} letters)`}
            value={form.password}
            onChange={handleChange}
            required
          />
