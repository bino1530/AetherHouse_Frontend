    ...
    <div className="od-page">
      ...
      <main className="od-main">
        <div className="od-container">
          ...
          {tab === "account" && (
            <>
              <h2 className="od-title">Your Account</h2>
              <section className="ua-grid">
                <div className="ua-card">
                  <div className="ua-header">
                    <div>
                      <p className="ua-name"><strong>Name</strong></p>
                      <p className="ua-name">{user?.name || "User"}</p>
                      <p className="ua-email"><strong>Email</strong></p>
                ...
                <div className="ua-card">
                  <h3 className="ua-card-title">Addresses <button className="ua-btn">+ Add</button></h3>
